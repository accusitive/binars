...
impl Module
{
    ...
    {
        ExpressionRef::new(unsafe { BinaryenConst(self.inner, Literal::int_32(v).inner) })
    }
    pub fn make_const_i64(&mut self, v: i64) -> ExpressionRef
    {
        ExpressionRef::new(unsafe { BinaryenConst(self.inner, Literal::int_64(v).inner) })
    }
    pub fn make_const_f32(&mut self, v: f32) -> ExpressionRef
    {
        ExpressionRef::new(unsafe { BinaryenConst(self.inner, Literal::float_32(v).inner) })
    }
    pub fn make_const_f64(&mut self, v: f64) -> ExpressionRef
    {
        ExpressionRef::new(unsafe { BinaryenConst(self.inner, Literal::float_64(v).inner) })
    }
